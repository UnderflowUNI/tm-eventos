...
export function Galeria() {
  ...
  const handleTouchEnd = (e: React.TouchEvent) => {
    ...
    // Swipe horizontal com pelo menos 50px e mais horizontal que vertical
  ...
  return (
    <section id="galeria" className="relative py-20 sm:py-28 lg:py-32 bg-ink-900 overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 auto-rows-[140px] sm:auto-rows-[160px] lg:auto-rows-[200px] gap-2 sm:gap-3 lg:gap-4">
          {FOTOS.map((foto, i) => (
            <div
              ...
              className={`relative overflow-hidden group cursor-pointer ring-1 ring-white/5 hover:ring-accent/40 transition-all duration-500 ${foto.className} ${
            ...
            >
              <div
                ...
                style={{ backgroundImage: `url(${foto.src})`, filter: "saturate(0.95) contrast(1.02)" }}
              />
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, rgba(94,234,212,0.35), transparent 70%)" }}
              />
      ...
      {lightbox !== null && (
        <div
          className="fixed inset-0 z-[60] bg-ink-900/97 backdrop-blur-xl flex flex-col items-center justify-center animate-fade-in"
        ...
        >
          {/* Botão fechar */}
          <button
            className="absolute top-4 right-4 sm:top-6 sm:right-6 w-10 h-10 flex items-center justify-center text-white/60 hover:text-accent border border-white/10 hover:border-accent rounded-md transition z-10"
          ...
          <button
            ...
            className="absolute left-3 sm:left-6 top-1/2 -translate-y-1/2 w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-ink-800/90 hover:bg-accent/20 border border-white/15 hover:border-accent text-white/80 hover:text-accent rounded-full transition z-10 shadow-lg"
            aria-label="Anterior"
          >
          ...
          <button
            ...
            className="absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center bg-ink-800/90 hover:bg-accent/20 border border-white/15 hover:border-accent text-white/80 hover:text-accent rounded-full transition z-10 shadow-lg"
            aria-label="Próxima"
          >
          ...
          >
            <div
              ...
              style={{
                backgroundImage: `url(${FOTOS[lightbox].src})`,
                aspectRatio: "4/3",
                maxHeight: "70vh",
              }}
            />
